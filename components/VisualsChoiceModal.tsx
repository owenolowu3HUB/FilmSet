...
const VisualsChoiceModal: React.FC<VisualsChoiceModalProps> = ({ onGenerate, onSkip, onClose }) => {
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-display font-bold text-accent">Generate Visual Concepts?</h2>
        <p className="text-text-secondary">
          Would you like the AI to generate concept art, character portraits, and other visuals for your pitch deck?
          This adds time to the analysis but creates a more complete package.
        </p>
        <p className="text-sm text-text-secondary">
          You can always upload your own images later if you skip this step.
        </p>
