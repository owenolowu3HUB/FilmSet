...
const StoryboardStudio: React.FC<StoryboardStudioProps> = ({ project, onUpdateStoryboardData, onUpdateSceneDescription, onClearStoryboardRequest }) => {
    ...
    useEffect(() => {
        ...
        if (storyboardRequest && storyboardRequest.length > 0 && project?.storyboardRequestContext) {
            generateFromShots(storyboardRequest, project.storyboardRequestContext, project?.shotIdeaStudioConfig, project?.script || '');
        }
    }, [storyboardRequest, project?.storyboardRequestContext, project?.shotIdeaStudioConfig, project?.script, onUpdateStoryboardData, onClearStoryboardRequest]);
