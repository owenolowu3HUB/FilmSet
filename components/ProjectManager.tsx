...
import { TrashIcon, ArrowUpIcon, ArrowDownIcon, UploadIcon } from './icons';
...
const ProjectManager: React.FC<ProjectManagerProps> = ({ projects, onLoad, onDelete, onClose, onImportProject }) => {
