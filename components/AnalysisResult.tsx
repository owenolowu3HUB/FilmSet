...
const AnalysisResult: React.FC<AnalysisResultProps> = ({ project, onNewProject, onUpdateStage2Data, onSave, onSaveAs, onExportProject }) => {
    ...
    const exportToPdf = () => {
        ...
        if (stage2Data.concept_art_base64) {
            const imgHeight = pdf.pageWidth * (9 / 16);
            pdf.checkPageBreak(imgHeight + 5);
            pdf.addBase64Image(stage2Data.concept_art_base64, pdf.margin, pdf.y, pdf.pageWidth, imgHeight);
            pdf.y += imgHeight + 5;
        }
